namespace WasatchNET
{
    public class Opcodes
    {
        ...
        public const byte GET_ACTUAL_INTEGRATION_TIME              = 0xdf; // impl
        public const byte GET_CCD_GAIN                             = 0xc5; // impl
        public const byte GET_CCD_OFFSET                           = 0xc4; // impl
        public const byte GET_CCD_SENSING_THRESHOLD                = 0xd1; // impl
        public const byte GET_CCD_TEMP                             = 0xd7; // impl
        public const byte GET_CCD_TEMP_ENABLE                      = 0xda; // impl
        public const byte GET_CCD_TEMP_SETPOINT                    = 0xd9; // impl
        public const byte GET_DAC                                  = 0xd9; // impl
        public const byte GET_CCD_THRESHOLD_SENSING_MODE           = 0xcf; // impl
        public const byte GET_CCD_TRIGGER_SOURCE                   = 0xd3; // impl

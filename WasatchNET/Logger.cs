...
namespace WasatchNET
{
    ...
    public class WPFLogger : ILogger, INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler PropertyChanged;
        ////////////////////////////////////////////////////////////////////////
        // Private attributes
        ...
        static readonly WPFLogger instance = new WPFLogger();
        ...
        public LogLevel level
        {
            ...
            set
            {
                if (null != Environment.GetEnvironmentVariable("WASATCHNET_WPFLogger_FORCE"))
                    return;
        ...
        static public WPFLogger getInstance()
        {
            return instance;
        }
        ...
        public void setPathname(string path)
        {
            if (null != Environment.GetEnvironmentVariable("WASATCHNET_WPFLogger_FORCE"))
            {
                debug($"WPFLogger.setPathname({path}): ignoring due to WASATCHNET_WPFLogger_FORCE");
                return;
            }
        ...
        private WPFLogger()
        {
            var envLevel = Environment.GetEnvironmentVariable("WASATCHNET_WPFLogger_LEVEL");
            if (envLevel != null)
            {
                envLevel = envLevel.ToUpper();
                if (envLevel.Contains("DEBUG")) _level = LogLevel.DEBUG;
            ...
            var envPathname = Environment.GetEnvironmentVariable("WASATCHNET_WPFLogger_PATHNAME");
            if (envPathname != null)
            {
                // object isn't sufficiently constructed enough to use setPathname()?
                try

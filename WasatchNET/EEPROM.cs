        ...
        public bool read()
        {
            ...
            if (spectrometer is OceanSpectrometer)
            {
                ...
                */
                ...
                minIntegrationTimeMS = (ushort)(SeaBreezeWrapper.seabreeze_get_min_integration_time_microsec(a.specIndex, ref errorReader) / 1000);//(ushort)a.wrapper.getMinIntegrationTimeMillisec();//ParseData.toUInt16(pages[2], 21); // will overwrite if 
